...
# http://ftp2.de.freebsd.org/pub/FreeBSD/releases/ISO-IMAGES/14.3/FreeBSD-14.3-RELEASE-arm64-aarch64-bootonly.iso
# http://ftp2.de.freebsd.org/pub/FreeBSD/releases/OCI-IMAGES/14.3-RELEASE/aarch64/Latest/FreeBSD-14.3-RELEASE-arm64-aarch64-container-image-runtime.txz
...
ISO_IMAGE_URL="http://ftp2.de.freebsd.org/pub/FreeBSD/releases/ISO-IMAGES/$BSD_RELEASE_VERSION/$BSD_RELEASE_NAME-bootonly.iso"

OCI_IMAGE="$BSD_RELEASE_NAME-container-image-runtime.txz"
OCI_IMAGE_URL="http://ftp2.de.freebsd.org/pub/FreeBSD/releases/OCI-IMAGES/$BSD_RELEASE_VERSION-$BSD_RELEASE_SUFFIX/aarch64/Latest/$OCI_IMAGE"
