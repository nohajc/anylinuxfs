...
Full read-write access to ext4, btrfs, or any other Linux-supported filesystem on a Mac.
Based on the libkrun microVM hypervisor and NFS — no kernel extensions, no lowering system security.
...
- [vmnet-helper](https://github.com/nirs/vmnet-helper) - utility for using macOS vmnet Framework (provides IP addresses to VMs)
